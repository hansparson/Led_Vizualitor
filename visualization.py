...
if __name__ == '__main__':
    if config.USE_GUI:
        ...
        def led_plus_click(x):
            global visualization_effect
            visualization_effect = visualize_spectrum
            config.N_PIXELS = config.N_PIXELS + 5 
            led_number.setText('LED = {}'.format(config.N_PIXELS))
        def led_minus_click(x):
            global visualization_effect
            visualization_effect = visualize_spectrum
            config.N_PIXELS = config.N_PIXELS + 5
            led_number.setText('LED = {}'.format(config.N_PIXELS))
        ...
        led_number = pg.LabelItem('LED = {}'.format(config.N_PIXELS))
        led_plus = pg.LabelItem('LED +5')
        led_minus = pg.LabelItem('LED -5')
        scroll_label = pg.LabelItem('Scroll')
        spectrum_label = pg.LabelItem('Spectrum')
        led_plus.mousePressEvent = led_plus_click
        led_minus.mousePressEvent = led_minus_click
        ...
        layout.nextRow()
        # layout.addItem(led_number)
        # layout.addItem(led_plus)
        # layout.addItem(led_minus)
    # Initialize LEDs
    led.update()
